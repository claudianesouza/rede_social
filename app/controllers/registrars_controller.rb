class RegistrarsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @registrar.save
        format.html { redirect_to @registrar, notice: 'Conta criada com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @registrar.update(registrar_params)
        format.html { redirect_to @registrar, notice: 'Conta alterada com sucesso.' }
  ...
  def destroy
    @registrar.destroy
    respond_to do |format|
      format.html { redirect_to registrars_url, notice: 'Conta excluida com sucesso.' }
  ...
  private
    ...
    def registrar_params
      params.require(:registrar).permit(:nome, :sobrenome, :email, :senha)
    end
end
